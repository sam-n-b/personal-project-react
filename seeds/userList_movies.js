  ...
  return knex('userList_movies').del()
    .then(function () {
      ...
      return knex('userList_movies').insert([
        ...
        {id: 504, userId: 1, movieId:864, rating:5, review:'Too good'},
        ...
        {id: 513, userId: 4, movieId:597, rating:4, review:'good'},
        ...
        {id: 518, userId: 4, movieId:864, rating:3.5, review:'so so'},
